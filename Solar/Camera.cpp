...
void Camera::renderSkybox(Shader &skyShader) {
...
void Camera::initializeSkybox(Shader& skyShader) {
    ...
    {
        "assets/right.png", "assets/left.png", "assets/top.png", "assets/bottom.png", "assets/front.png", "assets/back.png"
    };
...
unsigned int Camera::loadCubemap(std::vector<std::string> faces)
{
